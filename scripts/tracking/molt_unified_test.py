...
class MOLTUnifiedTest:
    ...
    def __init__(self, 
                 video_path: str,
                 model_path: str = "/Users/abhinavrai/Playground/snooker_data/trained models/ar-snkr_objd-lolhi-3-yolov11-medium-weights.pt",
...
def main() -> bool:
    ...
    model_path = "/Users/abhinavrai/Playground/snooker_data/trained models/ar-snkr_objd-lolhi-3-yolov11-medium-weights.pt"

...
class TestBallCountManager(unittest.TestCase):
    ...
    def test_update_counts_from_tracks(self):
    ...
    def test_update_counts_with_unknown_class(self):
    ...
    def test_verify_counts_valid(self):
    ...
    def test_verify_counts_violations(self):
    ...
    def test_get_count_violations(self):
    ...
    def test_handle_lost_ball(self):
    ...
    def test_handle_duplicate_ball(self):
    ...
    def test_suggest_track_merges(self):
    ...
    def test_update_expected_counts(self):
    ...
    def test_update_expected_counts_invalid(self):

...
from src.tracking.trackers.molt.population import TrackerPopulation
from src.tracking.trackers.molt.local_tracker import LocalTracker
...
def test_error_handling() -> None:
    ...
    assert len(tracker.populations) == 0  # type: ignore[unreachable]
